# Generated by Django 4.2.4 on 2023-08-16 00:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attended_events', to='levelupapi.event')),
            ],
        ),
        migrations.CreateModel(
            name='GameType',
        ...
        migrations.AddField(
            ...
            name='gamer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='levelupapi.gamer'),
        ),
        migrations.AddField(
            model_name='event',
            name='game',
